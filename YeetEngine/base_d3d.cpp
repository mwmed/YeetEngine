...
bool yeet_framework::base_d3d::create_device()
{
    bool result = false;
...
bool yeet_framework::base_d3d::cleanup_device()
{
    if (m_d3d) {
        m_d3d->Release();
        m_d3d = 0;
...
void yeet_framework::base_d3d::reset_device()
{
}

LPDIRECT3DDEVICE9 yeet_framework::base_d3d::get_device()
{
    return m_device;
}
